...
class Video():
	...
	""" This class is a parent class to Movie and TvShow. Use media.Movie() or media.TvShow() instead """
...
class Movie(Video):
	...
	def __init__(self, title, storyline, poster, trailer, duration, rating):
		Video.__init__(self, title, storyline, poster, trailer, duration, rating)

class TvShow(Video):
	# The class to create a tv-show. Added episodes and seasons.

	""" 
	media.Movie(title, storyline, poster, trailer, duration, rating, episodes, seasons)
	...
	def __init__(self, title, storyline, poster, trailer, duration, rating, episodes, seasons):
		Video.__init__(self, title, storyline, poster, trailer, duration, rating)
